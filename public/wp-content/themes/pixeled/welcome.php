...
$mysitefeed = get_bloginfo('rss2_url');
 ...
 if (get_option('greeting') || get_option('welcomemessage')) {
  ...
  echo "<h2>Welcome to $mysitename!</h2><p>Thanks for dropping by! Feel free to join the discussion by leaving comments, and stay updated by subscribing to the <a href='$mysitefeed'>RSS feed</a>. See ya around!</p>";
}
