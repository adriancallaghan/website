...
<div class="post" id="post-<?php the_ID(); ?>">
        ...
        <div class="storycontent">
				...
				<br />
				<span style="float:right;"><?php comments_popup_link( __( 'Add comment<br />Comments (0)', 'sandbox' ), __( 'Add comment<br />Comments (1)', 'sandbox' ), __( 'Add comment<br />Comments (%)', 'sandbox' ) ) ?></span>
				<br />
