...
Plugin URI: http://www.blogdev.info/bd/wordpress/my-plugins/wp-postviews-plus-widget.htm
...
Version: 1.0
Author: flyaga li
Author URI: http://www.blogdev.info/
*/
...
function widget_postview_plus_mostpopular_init() {
    ...
    function widget_postview_plus_mostpopular($args) {
        ...
        {global $wp_query;
          ...
          get_most_viewed('post', $number, 0, true, false);
		echo '</ul>';
        echo '<a style="font-size: 9px;" href="http://www.blogdev.info" target=_blank>By blogdev</a>';
        echo $after_widget;
    }
